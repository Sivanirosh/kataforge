...
Extracted by designlang on 2026-05-24.

## Brand at a glance

- title         Build Your Own AI Coding Agent Harness | Vercel Academy
- page intent   landing
...
- secondary   #52aeff
- accent      #0072f5
- neutrals    #171717 · #ebebeb · #4d4d4d · #ffffff · #666666 · #a8a8a8

## Typography

- families   Geist · geistMonoFont
- weights    400 · 500 · 600 · 700
- base size  16px

## Spacing

- scale      1px · 32px · 36px · 40px · 44px · 48px · 64px · 80px · 85px · 90px · 96px · 120px

## Radii

- scale      2px · 5px · 8px · 12px · 16px · 32px

## Motion

- durations  80ms · 90ms · 160ms · 300ms
